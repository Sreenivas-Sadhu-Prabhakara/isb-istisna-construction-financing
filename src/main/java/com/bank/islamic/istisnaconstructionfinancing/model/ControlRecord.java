package com.bank.islamic.istisnaconstructionfinancing.model;
...
/**
 * The BIAN control record for this service domain: "Istisna Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Istisna Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Istisna Facility Fulfillment Arrangement";
